...
| `cross-product-mcp-spawn-detector` | Claude Desktop の RPM プラグインのパスなど、 `~/.claude/` の外側で MCP server の spawn を引き起こす `.mcp.json` を session 開始時に検出（blocklist に該当する plugin 名のみ、 opt-in） | [#58806](https://github.com/anthropics/claude-code/issues/58806) |
