...
**Claude Codeを安全にするワンコマンドツール。** 653個のexample hook · 13,955テスト · 1,000+ インストール/日
...
| `--install-example <name>` | 653個のexampleから個別インストール |
...
> 📘 hookの設計パターンや自律セッション運用の実践例は[Claude Codeを本番品質にする — hook設計・運用ガイド](https://zenn.dev/yurukusa/books/6076c23b1cb18b)（¥800・第2章まで無料）にまとめています。
