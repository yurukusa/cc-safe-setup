...
test_ex deploy-guard.sh '{"tool_input":{"command":"firebase deploy"}}' 0 "firebase deploy detected"
test_ex deploy-guard.sh '{"tool_input":{"command":"vercel --prod"}}' 0 "vercel detected"
test_ex deploy-guard.sh '{"tool_input":{"command":"kubectl apply -f deploy.yaml"}}' 0 "kubectl apply detected"
test_ex deploy-guard.sh '{"tool_input":{"command":"terraform apply"}}' 0 "terraform apply detected"
...
test_ex crontab-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "crontab_guard: cmd"
test_ex crontab-guard.sh '{}' 0 "crontab_guard: empty"
test_ex debug-leftover-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "debug_leftover_gua: cmd"
...
test_ex diff-size-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "diff_size_guard: cmd"
test_ex diff-size-guard.sh '{}' 0 "diff_size_guard: empty"
test_ex disk-space-guard.sh '{}' 0 "disk_space_guard: empty"
test_ex docker-prune-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "docker_prune_guard: cmd"
test_ex docker-prune-guard.sh '{}' 0 "docker_prune_guard: empty"
test_ex edit-guard.sh '{"tool_input":{"file_path":"/tmp/test.txt"}}' 0 "edit_guard: file"
test_ex edit-guard.sh '{}' 0 "edit_guard: empty"
test_ex enforce-tests.sh '{"tool_input":{"file_path":"/tmp/test.txt"}}' 0 "enforce_tests: file"
test_ex enforce-tests.sh '{}' 0 "enforce_tests: empty"
test_ex env-drift-guard.sh '{"tool_input":{"file_path":"/tmp/test.txt"}}' 0 "env_drift_guard: file"
test_ex env-drift-guard.sh '{}' 0 "env_drift_guard: empty"
test_ex env-source-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "env_source_guard: cmd"
test_ex env-source-guard.sh '{}' 0 "env_source_guard: empty"
...
test_ex git-lfs-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "git_lfs_guard: cmd"
test_ex git-lfs-guard.sh '{}' 0 "git_lfs_guard: empty"
test_ex git-stash-before-danger.sh '{"tool_input":{"command":"echo hello"}}' 0 "git_stash_before_d: cmd"
test_ex git-stash-before-danger.sh '{}' 0 "git_stash_before_d: empty"
test_ex git-tag-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "git_tag_guard: cmd"
test_ex git-tag-guard.sh '{}' 0 "git_tag_guard: empty"
...
test_ex no-curl-upload.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_curl_upload: cmd"
test_ex no-curl-upload.sh '{}' 0 "no_curl_upload: empty"
test_ex no-deploy-friday.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_deploy_friday: cmd"
test_ex no-deploy-friday.sh '{}' 0 "no_deploy_friday: empty"
test_ex no-git-amend-push.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_git_amend_push: cmd"
test_ex no-git-amend-push.sh '{}' 0 "no_git_amend_push: empty"
test_ex no-install-global.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_install_global: cmd"
test_ex no-install-global.sh '{}' 0 "no_install_global: empty"
test_ex no-port-bind.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_port_bind: cmd"
test_ex no-port-bind.sh '{}' 0 "no_port_bind: empty"
test_ex no-secrets-in-logs.sh '{}' 0 "no_secrets_in_logs: empty"
test_ex no-sudo-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "no_sudo_guard: cmd"
test_ex no-sudo-guard.sh '{}' 0 "no_sudo_guard: empty"
