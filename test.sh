...
test_ex deploy-guard.sh '{"tool_input":{"command":"firebase deploy"}}' 0 "firebase deploy passes (no git repo in /tmp)"
test_ex deploy-guard.sh '{"tool_input":{"command":"vercel --prod"}}' 0 "vercel passes (no git repo in /tmp)"
test_ex deploy-guard.sh '{"tool_input":{"command":"kubectl apply -f deploy.yaml"}}' 0 "kubectl apply passes (no git repo in /tmp)"
test_ex deploy-guard.sh '{"tool_input":{"command":"terraform apply"}}' 0 "terraform apply passes (no git repo in /tmp)"
