...
test_hook "secret-guard" '{"tool_input":{"new_string":"AKIAIOSFODNN7EXAMPLE"}}' 2 "secret-guard: AWS key in new_string blocked"
test_hook "secret-guard" '{"tool_input":{"content":"sk-proj-abcdef1234567890"}}' 2 "secret-guard: OpenAI key in content blocked"
test_hook "secret-guard" '{"tool_input":{"new_string":"ghp_1234567890abcdef1234567890abcdef12345678"}}' 2 "secret-guard: GitHub PAT blocked"
test_hook "secret-guard" '{"tool_input":{"new_string":"password = hunter2"}}' 2 "secret-guard: password assignment blocked"
