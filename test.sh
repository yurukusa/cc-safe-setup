...
test_ex env-source-guard.sh '{"tool_input":{"command":"source .env"}}' 0 "env-source: source .env"
test_ex env-source-guard.sh '{"tool_input":{"command":". .env"}}' 0 "env-source: dot .env"
