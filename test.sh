...
test_ex no-git-amend-push.sh '{"tool_input":{"command":"git push --force"}}' 2 "git-amend: force push blocked"
test_ex no-git-amend-push.sh '{"tool_input":{"command":"git commit --amend && git push"}}' 2 "git-amend: amend+push blocked"
