...
test_ex edit-error-counter.sh '{"tool_name":"Bash","tool_input":{"command":"ls"}}' 0 "edit-error-counter: bash tool ignored"
test_ex edit-error-counter.sh '{"tool_name":"Write","tool_input":{"file_path":"/tmp/y"}}' 0 "edit-error-counter: write tool"
test_ex edit-error-counter.sh '{"tool_name":"Read","tool_input":{"file_path":"/tmp/z"}}' 0 "edit-error-counter: read ignored"
test_ex edit-error-counter.sh '{}' 0 "edit-error-counter: empty json"
test_ex edit-error-counter.sh '{"tool_name":"Edit","tool_input":{"file_path":"/tmp/a"},"tool_error":""}' 0 "edit-error-counter: empty error"
test_ex edit-error-counter.sh '{"tool_name":"Edit","tool_input":{"file_path":"/tmp/b"}}' 0 "edit-error-counter: no error field"
...
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"ls -la"}}' 0 "ansible-vault-guard: non-ansible"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"git status"}}' 0 "ansible-vault-guard: git"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"npm test"}}' 0 "ansible-vault-guard: npm"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"ansible --version"}}' 0 "ansible-vault-guard: version check"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"ansible-galaxy install role"}}' 0 "ansible-vault-guard: galaxy"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "ansible-vault-guard: echo"
test_ex ansible-vault-guard.sh '{"tool_input":{"command":"python3 -c import_ansible"}}' 0 "ansible-vault-guard: python"
...
test_ex hardcoded-ip-guard.sh '{"tool_name":"Write","tool_input":{"file_path":"/tmp/x.rb"}}' 0 "hardcoded-ip-guard: ruby no file"
test_ex hardcoded-ip-guard.sh '{"tool_name":"Edit","tool_input":{"file_path":"/tmp/x.swift"}}' 0 "hardcoded-ip-guard: swift no file"
test_ex hardcoded-ip-guard.sh '{}' 0 "hardcoded-ip-guard: empty input"
test_ex hardcoded-ip-guard.sh '{"tool_input":{"file_path":""}}' 0 "hardcoded-ip-guard: empty path"
test_ex hardcoded-ip-guard.sh '{"tool_name":"Bash","tool_input":{"command":"ls"}}' 0 "hardcoded-ip-guard: bash ignored"
test_ex hardcoded-ip-guard.sh '{"tool_name":"Read","tool_input":{"file_path":"/tmp/x.ts"}}' 0 "hardcoded-ip-guard: read ignored"
test_ex hardcoded-ip-guard.sh '{"tool_name":"Write","tool_input":{"file_path":"/tmp/x.c"}}' 0 "hardcoded-ip-guard: c no file"
...
test_ex mcp-config-freeze.sh '{"tool_input":{"file_path":"/home/.claude/settings.json","new_string":"add mcpServers config","content":"mcpServers"}}' 2 "mcp-freeze: settings.json with mcpServers BLOCKED"
...
# ========== denied-action-retry-guard (#40156) ==========
echo "denied-action-retry-guard.sh:"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"git push origin main"}}' 0 "denied-retry: first attempt allowed"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"ls -la"}}' 0 "denied-retry: normal command"
test_ex denied-action-retry-guard.sh '{"tool_name":"Edit","tool_input":{"file_path":"src/main.ts"}}' 0 "denied-retry: edit allowed"
test_ex denied-action-retry-guard.sh '{"tool_name":"Write","tool_input":{"file_path":"test.txt"}}' 0 "denied-retry: write allowed"
test_ex denied-action-retry-guard.sh '{}' 0 "denied-retry: empty input"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":""}}' 0 "denied-retry: empty command"
test_ex denied-action-retry-guard.sh '{"tool_name":"Read","tool_input":{"file_path":"a.txt"}}' 0 "denied-retry: Read not matched"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"npm test"}}' 0 "denied-retry: npm test"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"echo hello"}}' 0 "denied-retry: echo"
test_ex denied-action-retry-guard.sh '{"tool_name":"Edit","tool_input":{"file_path":""}}' 0 "denied-retry: empty file path"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"git status"}}' 0 "denied-retry: git status"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"python3 -c print(1)"}}' 0 "denied-retry: python"
test_ex denied-action-retry-guard.sh '{"tool_name":"Write","tool_input":{"file_path":"new-file.txt"}}' 0 "denied-retry: new file write"
test_ex denied-action-retry-guard.sh '{"tool_name":"Bash","tool_input":{"command":"cat README.md"}}' 0 "denied-retry: cat"
echo ""

# ========== public-repo-push-guard (#29225) ==========
echo "public-repo-push-guard.sh:"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git push origin main"}}' 0 "public-push: git push (checks remote)"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git status"}}' 0 "public-push: non-push allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"npm test"}}' 0 "public-push: non-git allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":""}}' 0 "public-push: empty command"
test_ex public-repo-push-guard.sh '{}' 0 "public-push: empty input"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git pull"}}' 0 "public-push: git pull allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git commit -m fix"}}' 0 "public-push: commit allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git log"}}' 0 "public-push: git log allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "public-push: echo allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"ls -la"}}' 0 "public-push: ls allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git diff HEAD"}}' 0 "public-push: diff allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git fetch"}}' 0 "public-push: fetch allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git add ."}}' 0 "public-push: add allowed"
test_ex public-repo-push-guard.sh '{"tool_input":{"command":"git branch -a"}}' 0 "public-push: branch allowed"
echo ""

# ========== issue-draft-redact-guard (#29121) ==========
echo "issue-draft-redact-guard.sh:"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh issue create --title test --body hello"}}' 0 "redact: clean issue allowed"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"ls -la"}}' 0 "redact: non-issue command"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"git push"}}' 0 "redact: git push not matched"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":""}}' 0 "redact: empty command"
test_ex issue-draft-redact-guard.sh '{}' 0 "redact: empty input"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh pr create --title fix --body ok"}}' 0 "redact: clean PR allowed"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"npm test"}}' 0 "redact: npm test"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"echo hello"}}' 0 "redact: echo"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh issue list"}}' 0 "redact: issue list (not create)"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh issue view 123"}}' 0 "redact: issue view"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"git status"}}' 0 "redact: git status"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh pr list"}}' 0 "redact: pr list"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"gh api repos/foo/bar"}}' 0 "redact: gh api"
test_ex issue-draft-redact-guard.sh '{"tool_input":{"command":"cat README.md"}}' 0 "redact: cat"
echo ""

# ========== check-before-act-enforcer (#40289) ==========
echo "check-before-act-enforcer.sh:"
test_ex check-before-act-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":"src/main.ts"}}' 2 "check-act: edit without read BLOCKED"
test_ex check-before-act-enforcer.sh '{"tool_name":"Write","tool_input":{"file_path":"new-file.txt"}}' 0 "check-act: new file write allowed"
test_ex check-before-act-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":""}}' 0 "check-act: empty path"
test_ex check-before-act-enforcer.sh '{}' 0 "check-act: empty input"
test_ex check-before-act-enforcer.sh '{"tool_name":"Read","tool_input":{"file_path":"test.txt"}}' 0 "check-act: Read not matched"
test_ex check-before-act-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"ls"}}' 0 "check-act: Bash not matched"
test_ex check-before-act-enforcer.sh '{"tool_name":"Write","tool_input":{"file_path":""}}' 0 "check-act: Write empty path"
test_ex check-before-act-enforcer.sh '{"tool_name":"Grep","tool_input":{"pattern":"foo"}}' 0 "check-act: Grep not matched"
test_ex check-before-act-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":"package.json"}}' 2 "check-act: edit package.json without read"
test_ex check-before-act-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":".gitignore"}}' 2 "check-act: edit dotfile without read"
test_ex check-before-act-enforcer.sh '{"tool_name":"Glob","tool_input":{"pattern":"*.ts"}}' 0 "check-act: Glob not matched"
test_ex check-before-act-enforcer.sh '{"tool_name":"Agent","tool_input":{"prompt":"do stuff"}}' 0 "check-act: Agent not matched"
test_ex check-before-act-enforcer.sh '{"tool_name":"Write","tool_input":{"file_path":"src/brand-new.ts"}}' 0 "check-act: Write new file allowed"
test_ex check-before-act-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":"README.md"}}' 2 "check-act: edit README without read"
echo ""

# ========== absolute-rule-enforcer (#40284) ==========
echo "absolute-rule-enforcer.sh:"
test_ex absolute-rule-enforcer.sh '{}' 0 "absolute-rule: empty input (no CLAUDE.md)"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Stop"}' 0 "absolute-rule: stop event"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"ls"}}' 0 "absolute-rule: bash"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Read","tool_input":{"file_path":"test.txt"}}' 0 "absolute-rule: read"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Edit","tool_input":{"file_path":"src/main.ts"}}' 0 "absolute-rule: edit"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Write","tool_input":{"file_path":"out.txt"}}' 0 "absolute-rule: write"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Grep","tool_input":{"pattern":"foo"}}' 0 "absolute-rule: grep"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Glob","tool_input":{"pattern":"*.ts"}}' 0 "absolute-rule: glob"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Agent","tool_input":{"prompt":"research"}}' 0 "absolute-rule: agent"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"npm test"}}' 0 "absolute-rule: npm test"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"echo 1"}}' 0 "absolute-rule: echo"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"git status"}}' 0 "absolute-rule: git status"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Read","tool_input":{"file_path":"CLAUDE.md"}}' 0 "absolute-rule: read CLAUDE.md"
test_ex absolute-rule-enforcer.sh '{"tool_name":"Bash","tool_input":{"command":"cat CLAUDE.md"}}' 0 "absolute-rule: cat CLAUDE.md"
echo ""
