...
# READ_ONLY_RE below treats that segment as read-only - so the git write on
# the right-hand side of the pipe is never examined at all. Measured on the
# published file 2026-09-15: four piped shapes exited 0 while the same git
# operations exited 2 when written plainly.
#
