...
if (HELP) {
  ...
  Install & Configure:
    --install-example <name>       Install from 800+ example hooks
...
async function main() {
  ...
  console.log();
  console.log('  ' + c.blue + 'Zenn books (JP):' + c.reset + ' Author\'s own battle-tested playbooks from 800h of autonomous runs');
