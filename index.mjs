...
async function main() {
  ...
  console.log('  ' + c.dim + 'Updates:' + c.reset + '  https://yurukusa.github.io/cc-safe-setup/safety-lab.html?utm_source=cc-safe-setup-install  (¥500/month monthly incident roundup)');
